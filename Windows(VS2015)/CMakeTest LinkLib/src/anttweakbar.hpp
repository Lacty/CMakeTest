...
inline void TwEventMouseWheelGLFW3(GLFWwindow* window, double xoffset, double yoffset) { TwMouseWheel(yoffset); }
...
inline void TwEventWindowSizeGLFW3(GLFWwindow* window, int width, int height) { TwWindowSize(width, height); }